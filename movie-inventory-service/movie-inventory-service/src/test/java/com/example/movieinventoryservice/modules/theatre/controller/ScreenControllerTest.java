...
//
//		MvcResult result = this.mockMvc.perform(get("/screen/id/1")).andExpect(MockMvcResultMatchers.status().isOk())
//				.andReturn();
...
//		MvcResult result = this.mockMvc.perform(get("/screen/all")).andExpect(MockMvcResultMatchers.status().isOk())
//				.andReturn();
//		System.out.println(result.getResponse().getContentAsString());
//		assertTrue(result.getResponse().getContentAsString().contains("sampleText"));
//	}
...
//		MvcResult result = mockMvc.perform(post("/screen/add").contentType(MediaType.APPLICATION_JSON)
...
//		MvcResult result = mockMvc.perform(put("/screen/update").contentType(MediaType.APPLICATION_JSON)
//				.content(getScreensAsJson()).characterEncoding("utf-8")).andExpect(status().isOk()).andReturn();
//		System.out.println(result.getResponse().getContentAsString());
...
//		MvcResult result = this.mockMvc.perform(delete("/screen/id/1"))
