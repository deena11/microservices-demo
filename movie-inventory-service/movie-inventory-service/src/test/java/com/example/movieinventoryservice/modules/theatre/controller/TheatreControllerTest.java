...
//
//		MvcResult result = this.mockMvc.perform(get("/theatre/id/1")).andExpect(MockMvcResultMatchers.status().isOk())
//				.andReturn();
...
//		MvcResult result = this.mockMvc.perform(get("/theatre/all")).andExpect(MockMvcResultMatchers.status().isOk())
//				.andReturn();
//		System.out.println(result.getResponse().getContentAsString());
//		assertTrue(result.getResponse().getContentAsString().contains("sampleText"));
//	}
...
//		MvcResult result = mockMvc.perform(post("/theatre/add").contentType(MediaType.APPLICATION_JSON)
...
//		MvcResult result = mockMvc.perform(put("/theatre/update").contentType(MediaType.APPLICATION_JSON)
//				.content(getTheatresAsJson()).characterEncoding("utf-8")).andExpect(status().isOk()).andReturn();
//		System.out.println(result.getResponse().getContentAsString());
...
//		MvcResult result = this.mockMvc.perform(delete("/theatre/id/1"))
