...
//
//		MvcResult result = this.mockMvc.perform(get("/movies/id/1")).andExpect(MockMvcResultMatchers.status().isOk())
//				.andReturn();
...
//		MvcResult result = this.mockMvc.perform(get("/movies/all")).andExpect(MockMvcResultMatchers.status().isOk())
//				.andReturn();
//		System.out.println(result.getResponse().getContentAsString());
//		assertTrue(result.getResponse().getContentAsString().contains("Aladdin"));
//	}
...
//		MvcResult result = mockMvc.perform(post("/movies/add").contentType(MediaType.APPLICATION_JSON)
...
//		MvcResult result = mockMvc.perform(put("/movies/update").contentType(MediaType.APPLICATION_JSON)
//				.content(getMoviesAsJson()).characterEncoding("utf-8")).andExpect(status().isOk()).andReturn();
//		System.out.println(result.getResponse().getContentAsString());
...
//		MvcResult result = this.mockMvc.perform(delete("/movies/id/1")).andExpect(MockMvcResultMatchers.status().isOk())
//				.andReturn();
//		System.out.println(result.getResponse().getContentAsString());
